...
from tester_STPLS3D import ModelTester
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_folder', type=str, default=r'E:\syntheticVSreal_experiements\STPLS3D_prepared\RealWorldData', help='The directory that contains all data')
    parser.add_argument('--test_area', type=str, default='ResidentialArea_GT', help='Which area to use for test')
    parser.add_argument('--mode', type=str, default='train', help='options: train, test, vis')
    parser.add_argument('--model_path', type=str, default=r'None', help='pretrained model path')
