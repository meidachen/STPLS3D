...
def convert_pc2ply(dataOriginal_fpath, save_path):
...
if __name__ == '__main__':
    sub_grid_size = 0.3
    dataOriginal_dir = r'E:\syntheticVSreal_experiements\STPLS3D\RealWorldData'
    dataTraining_dir = r'E:\syntheticVSreal_experiements\STPLS3D_prepared\RealWorldData'
    ...
    for dataOriginal_fpath in dataOriginal_flist:
        ...
        convert_pc2ply(dataOriginal_fpath, save_path)
    print (labelCount)
